...
public class NewPlayer : PhysicsObject
{
    ...
    void Start()
    {
        ...
        ChangeAllSprites(newCharacterSprite);
    }
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            StartCoroutine(Die()); // Trigger the death sequence immediately
        }
    }
    ...
    public Sprite newCharacterSprite; // Assign this sprite in the Unity Editor

    public void ChangeAllSprites(Sprite newSprite)
    {
        if (graphicSprites != null && newSprite != null)
        {
            foreach (Component comp in graphicSprites)
            {
                SpriteRenderer spriteRenderer = comp as SpriteRenderer;
